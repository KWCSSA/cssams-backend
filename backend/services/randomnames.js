...
var left = ["大方", "年轻", "聪明", "雪白", "漂亮", "笔直", "时尚", "秀气",
						"优秀", "慌张", "俗气", "马虎", "博学", "兴奋", "欢快", "高兴",
						"幸福", "白净", "平静", "结实", "健壮", "伟大", "勇敢", "坚强",
						"温柔", "平淡", "简单", "固执", "醒目", "干净", "傲慢", "倔强",
						"脆弱", "乐观", "爽朗", "豪放", "开朗", "爱笑", "娇柔", "友好",
						"活泼", "昂贵", "孤独", "好动", "愉快", "热情", "可亲", "健谈",
						"轻松", "机敏", "外向", "爱哭", "扮丑", "率直", "巨大", "渺小",
						"善良", "文雅", "整洁", "内向", "沉静", "稳重", "顺从", "温和",
						"老实", "沉著", "和气", "体贴", "忠诚", "知足", "果断", "傲娇",
						"喜气", "善变", "迷糊", "保守", "忠心", "迷惑", "自信", "独立",
...
var right = ["泡泡糖", "肉包子", "饺子", "粽子", "桃子", "苹果", "樱桃", "白富美",
							...
							"备胎", "牛仔", "洛丽塔","丑八怪", "皇上", "王母娘娘", "仙桃", "九尾狐",
							"棉签", "牙签", "红包", "鼠标", "圣诞树", "雪花", "二锅头", "皮皮鲁"
];
